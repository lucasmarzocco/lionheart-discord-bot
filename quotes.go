...
var(
	QUOTES = [...]string{
		...
		"Remember Your Artistry. - Juan",
		"Seeing is not believing. Believing, is seeing it. - Juan",
		"On your final day on Earth, the person you became in this world, will meet the person you could have become. I hope it’s a perfect reflection. - Juan Lionheart",
		...
		"Forgiveness comes when what happened to you no longer influences your decisions and actions. - Juan Lionheart",
		...
		"Overwhelmed by a giant task? Apply A.S.S. - Aggregate, Simplify, Sort. - Juan Lionheart",
		...
		"People know what someone’s character is. Are they reliable? Are they honest? Do they like to bend the truth? Are they punctual, etc.  Culture, on the other hand, is the character of an organization or group of associated persons. Does the organization value punctuality or does it tolerate tardiness? Does the group ‘take care of its own’? In this way, one’s character is molded  by a group’s culture. - Juan Lionheart",
		...
		"Be someone you could admire. - Juan Lionheart",
		"Whether you think you can or you can’t - either way, you’re right. - Henry Ford",
		"What you reveal, you heal. - Jay Z",
		"Know what the difference is between a vision, delusion, and a hallucination is? it’s a hallucination when no one can see it, and it is pragmatically unattainable.  A delusion is a plausible vision that may be unattainable, but is healthy to a degree. A vision, however, is something others can see. They can see its plausibility. You can clearly articulate it and arouse others to it. That’s the difference. - Juan Lionheart",
	}
)
